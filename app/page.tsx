  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="relative flex flex-col items-center justify-center h-full p-8 text-center text-white">
        <h1 className="text-5xl font-bold">Igniting Ideas, Inspiring Positive Change</h1>
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pl-8">
            ...
            <p className="mb-6">
              ...
              collaboration, we can create truly unique and impactful experiences. In 2019, we launched our inaugural
              event, themed 'Dare to Disrupt', which brought together an electrifying mix of voices from the African
              Leadership University community and beyond. Our goal is to inspire and empower our attendees to think
              differently, share their ideas, and make a meaningful impact in their communities.
            </p>
      ...
      <section className="p-8 my-8">
        <div className="flex flex-col md:flex-row items-center justify-between bg-gray-200 p-4">
          <div className="md:w-1/2">
            ...
            <p className="mb-6">
              TEDxALURwanda is an independently organized, University TEDx event at the renowned African Leadership
              University licensed by TED. Since its inception in 2019, it has grown to become a flagship event at our
              university and within Rwanda, celebrated for its dynamic and disruptive ideas. The inaugural event, themed
              "Dare to Disrupt", set a powerful precedent, followed by the equally impactful 2023 event under the theme
              "What If?". Each year, we feature an exceptional lineup of speakers from various industries and our
              community, making TEDxALURwanda a recognized platform for sharing innovative and transformative ideas that
